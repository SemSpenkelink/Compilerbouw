...
public interface EloquenceVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitStatExpr(EloquenceParser.StatExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitParamVal(EloquenceParser.ParamValContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitParamRef(EloquenceParser.ParamRefContext ctx);
}