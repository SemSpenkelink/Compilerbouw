...
public interface EloquenceListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterStatVoid(EloquenceParser.StatVoidContext ctx);
	/**
	 * Exit a parse tree produced by the {@code statVoid}
	 * labeled alternative in {@link EloquenceParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatVoid(EloquenceParser.StatVoidContext ctx);
	/**
	 * Enter a parse tree produced by the {@code statExpr}
	 * labeled alternative in {@link EloquenceParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterStatExpr(EloquenceParser.StatExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code statExpr}
	 * labeled alternative in {@link EloquenceParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatExpr(EloquenceParser.StatExprContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterParamVal(EloquenceParser.ParamValContext ctx);
	/**
	 * Exit a parse tree produced by the {@code paramVal}
	 * labeled alternative in {@link EloquenceParser#parameters}.
	 * @param ctx the parse tree
	 */
	void exitParamVal(EloquenceParser.ParamValContext ctx);
	/**
	 * Enter a parse tree produced by the {@code paramRef}
	 * labeled alternative in {@link EloquenceParser#parameters}.
	 * @param ctx the parse tree
	 */
	void enterParamRef(EloquenceParser.ParamRefContext ctx);
	/**
	 * Exit a parse tree produced by the {@code paramRef}
	 * labeled alternative in {@link EloquenceParser#parameters}.
	 * @param ctx the parse tree
	 */
	void exitParamRef(EloquenceParser.ParamRefContext ctx);
}